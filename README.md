## Как запустить:
- в главной папке выполнить из терминала команду `./start-dev-all.sh`
- перейти на https://localhost/services-info-page/ - это страница с ссылками на сайт, api-документацию и PGAdmin
- или сразу перейти на https://localhost/ - сайт с игрой
- если в браузере ругнется на сертификат, то нажать Продолжить - проект запускается локально с самоподписным сертификатом, и чтоб не ругалось, нужно это настроить - создать собственный локальный корневой сертификат и импортировать его в доверенные персональные хранилища системы и браузера 
